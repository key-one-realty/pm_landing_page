...
export const useComponentStore = create<ComponentStoreState>()((set) => ({
    ...
    setServiceSection: (ref: HTMLElement | null) => {
        set(() => ({
            serviceSection: ref
        }))
    },
    setAboutSection: (ref: HTMLElement | null) => {
        set(() => ({
            aboutSection: ref
        }))
    },
    setContactSection: (ref: HTMLElement | null) => {
        set(() => ({
            contactSection: ref
        }))
    },
    setHomeSection: (ref: HTMLElement | null) => {
        set(() => ({
            homeSection: ref
        }))
    },
    setPopupFormSection: (ref: HTMLElement | null) => {
        set(() => ({
            popupFormSection: ref
        }))
    },
