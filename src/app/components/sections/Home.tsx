    ...
    >
      ...
      <div className="w-full min-h-svh  lg:flex lg:justify-between lg:items-center lg:flex-col">
        ...
        <div className="main-content flex-center">
          <div className="z-10 relative w-full h-fit gap-20 lg:gap-0 lg:w-10/12 2xl:w-8/12 flex-col-start-between flex-col justify-evenly pb-20 lg:justify-between lg:items-end lg:flex-row-reverse pb-20">
